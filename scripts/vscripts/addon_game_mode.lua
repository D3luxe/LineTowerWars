...
function Precache( context )
	...
	PrecacheUnitByNameSync("useless_tower", context)
	PrecacheUnitByNameSync("pitiful_tower", context)
	PrecacheUnitByNameSync("sharp_tower", context)
	PrecacheUnitByNameSync("bloody_tower", context)
	PrecacheUnitByNameSync("basic_tower", context)
	PrecacheUnitByNameSync("cannon_tower", context)
	PrecacheUnitByNameSync("crusher", context)
	PrecacheUnitByNameSync("lame_tower", context)
